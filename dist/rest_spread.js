...
function somarComRest() {
  ...
  var soma = numeros.reduce(function (total, numerAtual) {
    total += numerAtual;
    return total;
  }, 0);
  return soma;
...
var timesFutebolRj = ['Vasco', 'Botafogo', 'Flamengo', 'Fluminense'];
var timesFutebol = timesFutebolSp.concat(timesFutebolRj);
console.log(timesFutebol);
var spreadTimesFutebol = [].concat(timesFutebolSp, [timesFutebolRj]);
...
var _timesFutebol = _toArray(timesFutebol),
  ...
  item4 = _timesFutebol[3],
  outrosTimes = _timesFutebol.slice(4);
console.log(item1);
console.log(item2);
console.log(item3);
console.log(item4);
